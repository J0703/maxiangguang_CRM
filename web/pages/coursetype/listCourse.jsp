...
<form action="${pageContext.request.contextPath}/course/findAll.action" method="post">
...
<table width="97%" border="1">
    ...
    <s:iterator var="course" value="pageBean.data">
        <tr class="tabtd1">
...
<table border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
        <td align="right">
            ...
            <span>
        	<a href="${pageContext.request.contextPath}/course/findAll.action?">[首页]</a>&nbsp;&nbsp;

            <a href="${pageContext.request.contextPath}
                /course/findAll.action?pageNum=${pageBean.pageNum - 1}">[上一页]</a>&nbsp;&nbsp;

            <a
                    <c:choose>
                        <c:when test="${pageBean.pageNum >= pageBean.totalPage}">href="#"</c:when>
                        <c:otherwise>href="${pageContext.request.contextPath}
                            /course/findAll.action?pageNum=${pageBean.pageNum + 1}"</c:otherwise>
                    </c:choose>
            >[下一页]</a>&nbsp;&nbsp;

            <a href="${pageContext.request.contextPath}
                /course/findAll.action?pageNum=${pageBean.totalPage}&startTotal=">[尾页]</a>
        </span>
        </td>
    </tr>
</table>
